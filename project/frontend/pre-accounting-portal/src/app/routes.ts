...
export const APP_ROUTES: AppRoute[] = [
  ...
  { key: 'musteri-detay', label: 'Müşteri Detay', path: '/musteri-detay', component: CustomerDetailPage, allowedTemplates: 'all' },
  ...
  { key: 'cek-senet', label: 'Çek/Senet', path: '/cek-senet', component: ChequeNotePage, allowedTemplates: ['yonetici', 'muhasebe_sorumlusu'] },
